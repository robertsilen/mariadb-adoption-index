...
with open('data/github_new_prs_external/since-2023-01-01.csv', mode='w', newline='', encoding='utf-8') as file:
    writer = csv.DictWriter(file, fieldnames=pr_data[0].keys())
    writer.writeheader()
    writer.writerows(pr_data)

print("Data saved to data/github_new_prs_external/since-2023-01-01.csv")